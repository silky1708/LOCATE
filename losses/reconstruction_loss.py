...
class BCELoss:
    ...
    def __call__(self, pred, gt, train=True):
        return self.loss(pred, gt, train=train)

    def loss(self, pred, gt, train=True, multiplier=1.):
        return self.criterion(pred, gt) * multiplier
